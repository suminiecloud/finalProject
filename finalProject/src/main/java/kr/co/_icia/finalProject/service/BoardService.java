...
public class BoardService {
  ...
  public void registReview(writeReviewForm writeReviewForm) throws Exception {
    ...
    for (MultipartFile bFile : FileList) {
      if (!bFile.isEmpty()) {
        ...
        String savePath = "D:\\finalProject\\finalProject\\src\\main\\resources\\static\\imgs";
  ...
  public BestCheck memberCheck(Long memberId) {
    BestCheck memberCheck = bestCheckRepository.findByMemberId(memberId);
