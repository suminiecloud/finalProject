...
public class MemberController {
  ...
  public String signUp(@ModelAttribute("memberJoinForm") @Valid MemberJoinForm memberJoinForm, BindingResult result)
    ...
    try {
      ...
      if (memberJoinForm.getMstate() == null) {
        memberJoinForm.setMstate("C0");
      }
  ...
  public String memberLogin(@RequestParam("mid") String mid, @RequestParam("mpw") String mpw,Model model, RedirectAttributes ra) {
  ...
  public String memInfoPage(Model model, RedirectAttributes ra) {
    ...
    Members member = memberService.findByMidCheck((String) mid);
  ...
  public String memEdit(Model model, @ModelAttribute("form") @Valid MemberJoinForm form, BindingResult result)
    ...
    memberService.updateMember(form, mid);
    return "redirect:/";
  }
