...
planSocket.onmessage = function(event) {
  ...
  sharedPlanBtn.parentElement.classList.remove('d-none');
...
function showToastAlert_Plan(plan) {
  ...
  toastAlertEl.innerHTML =
    `<a href="/receivePlanView" class="toast-container position-fixed top-0 end-0 p-3">
